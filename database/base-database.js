...
class BaseDatabase{
    ...
    async removeBy(property,value){
        ...
        if (index == -1) throw new Error(`Concat find ${this.model.name} instance with ${property} ${value}`)
    ...
    async update(object){
        ...
        if(index==-1)throw new Error(`Concat find ${this.model.name} instance with id ${object.id}`)
